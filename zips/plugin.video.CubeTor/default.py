...
def Categories(): #0
	...
	xx.AddDir("[COLOR white]Nos Cinemas[/COLOR]", "now_playing", "tmdb.InTheaters", isFolder=True, dados={"region": "br"})
	if Ctrakt:
		xx.AddDir("[COLOR ffff3355]Filmes Trakt (Watchlist)[/COLOR]", "", "trakt.ListMoviesWatchList", isFolder=True)
	if CtraktAuth:
		xx.AddDir("[COLOR ffff3355]Filmes Trakt (Começados)[/COLOR]", "", "trakt.MoviesStarted", isFolder=True)
	if cDirtrtvDown:
...
#-------------------------------
	...
	tmdb.tvshow_recom()
elif mode == "tmdb.tvshow_recomShow":
	tmdb.tvshow_recomShow()
	xx.setViewS()
...
#-------------------------------
	...
	trakt.ListSeries('https://api.trakt.tv/users/'+Ctrakt+'/lists/trailers-to/items/shows','DialogProgressBG',whereto="ShowsOptions",Play=[False,False])
	xx.setViewS()
elif mode == "trakt.Shows":
	trakt.Shows()
	xx.setViewS()
elif mode == "trakt.ShowsOptions":
	trakt.ShowsOptions()
elif mode == "trakt.ShowsNext":
	trakt.ShowsNext()
elif mode == "trakt.ShowsNextDownload":
	trakt.ShowsNext("download")
elif mode == "trakt.Seasons":
	trakt.Seasons()
	xx.setViewS()
elif mode == "trakt.SeasonsUrl":
	trakt.Seasons("trakt.EpisodesUrl")
	xx.setViewS()
elif mode == "trakt.Episodes":
	trakt.Episodes()
	xx.setViewS2()
elif mode == "trakt.EpisodesUrl":
	trakt.Episodes("trakt.PlayUrl")
	xx.setViewS2()
elif mode == "trakt.PlayUrl":
	trakt.PlayUrl()
	...
	trakt.ListMovies()
	xx.setViewS()
elif mode == "trakt.MoviesStarted":
	trakt.MoviesStarted()
	xx.setViewS()
elif mode == "trakt.Auth":
	trakt.Auth()
#-------------------------------
...
#-------------------------------
	...
	google.BuscaCat()
	xx.setViewM2()
elif mode == "google.BuscaAllPre":
	google.BuscaAllPre()
elif mode == "google.BuscaAll":
	google.BuscaAll()
	xx.setViewM()
elif mode == "google.BuscaTrtvTvshow":
	google.BuscaTrtvTvshow()
	xx.setViewM()
#-------------------------------
elif mode == "Reload":
